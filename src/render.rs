...
static MERMAID_ADAPTER: GhrmBlockAdapter = GhrmBlockAdapter { class: "ghrm-mermaid", canvas: "ghrm-mermaid-diagram" };
static GEOJSON_ADAPTER: GhrmBlockAdapter = GhrmBlockAdapter { class: "ghrm-geojson", canvas: "ghrm-map-canvas" };
static TOPOJSON_ADAPTER: GhrmBlockAdapter = GhrmBlockAdapter { class: "ghrm-topojson", canvas: "ghrm-map-canvas" };
...
pub fn render(md: &str) -> Rendered {
    ...
    plugins.render.codefence_renderers.insert("mermaid".to_string(), &MERMAID_ADAPTER);
    plugins.render.codefence_renderers.insert("geojson".to_string(), &GEOJSON_ADAPTER);
    plugins.render.codefence_renderers.insert("topojson".to_string(), &TOPOJSON_ADAPTER);
    plugins.render.codefence_renderers.insert("math".to_string(), &MATH_ADAPTER);
...
impl CodefenceRendererAdapter for GhrmMathAdapter {
    fn write(
        ...
        write!(out, r#"<div class="ghrm-math-block">$$
{}
$$</div>"#, escaped)
    }
}
...
fn rewrite_math_display(html: &str) -> String {
    ...
    loop {
        ...
        out.push_str(r#"<div class="ghrm-math-block">$$
"#);
...
mod tests {
    ...
    fn mermaid_wraps_ghrm_block() {
        ...
        assert!(r.html.contains(r#"<div class="ghrm-mermaid-diagram"></div>"#));
    ...
    fn alert_note_has_admonition_classes_and_svg() {
        let md = "> [!NOTE]\n> body\n";
        let r = render(md);
        assert!(r.html.contains(r#"markdown-admonition markdown-admonition-note"#));
